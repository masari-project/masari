...
* Running masari node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/masariexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/masari/testnet_pvt```. 
